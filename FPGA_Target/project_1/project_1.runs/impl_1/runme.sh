...
HD_PWD='C:/Users/Raad Mahmood/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab_2_task.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab_2_task.tcl -notrace
