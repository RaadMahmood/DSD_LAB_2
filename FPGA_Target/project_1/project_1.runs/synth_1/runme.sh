...
HD_PWD='C:/Users/Raad Mahmood/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab_2_task.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab_2_task.tcl
